...
import { ShieldAlert, Clock, Cpu, ServerCog } from 'lucide-react';
        ...
        {selectedRun ? (
          <>
            <Card className="shrink-0">
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="bg-slate-50 p-3 rounded border border-slate-100">
                  ...
                  <p className="font-medium text-slate-800">{selectedRun.status}</p>
                </div>
                <div className="bg-slate-50 p-3 rounded border border-slate-100">
                  <p className="text-xs text-slate-500 mb-1">Model</p>
                  <p className="font-medium text-slate-800">{selectedRun.model_name}</p>
                </div>
                <div className="bg-slate-50 p-3 rounded border border-slate-100">
                  <p className="text-xs text-slate-500 mb-1">Latency</p>
                  <p className="font-medium text-slate-800">{selectedRun.latency_ms} ms</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 shadow-sm flex-1 overflow-hidden flex flex-col">
              <div className="p-4 border-b border-slate-100 bg-slate-50 font-medium text-slate-800 shrink-0 flex items-center">
                    ...
                    <div key={tc.id} className="bg-white border border-slate-200 rounded-lg overflow-hidden shadow-sm">
                      ...
                      <div className="grid grid-cols-2 divide-x divide-slate-100">
                        ...
                        <div className="p-4">
                          ...
                          <pre className="text-[10px] bg-slate-50 p-2 rounded text-slate-700 overflow-x-auto max-h-64">
